    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_assets_and_maintenances", x => new { x.asset_id, x.maintenance_id });
                    table.ForeignKey(
                        name: "fk_assets_and_maintenances_assets_asset_id",
                        column: x => x.asset_id,
                        principalSchema: "public",
                        principalTable: "assets",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "fk_assets_and_maintenances_maintenances_maintenance_id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_teams_assets_asset_entity_id",
                        column: x => x.asset_entity_id,
                        principalSchema: "public",
                        principalTable: "assets",
                        principalColumn: "id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    id = table.Column<Guid>(type: "uuid", nullable: false),
                    no = table.Column<string>(type: "character varying(3)", maxLength: 3, nullable: true),
                    title = table.Column<string>(type: "text", nullable: false),
                    description = table.Column<string>(type: "text", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "fk_work_orders_users_assignee_id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "fk_files_requests_request_id",
                        column: x => x.request_id,
                        principalSchema: "public",
                        principalTable: "requests",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "fk_files_work_orders_work_order_id",
                        column: x => x.work_order_id,
                        principalSchema: "public",
                        principalTable: "work_orders",
                        principalColumn: "id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_parts_assets_asset_entity_id",
                        column: x => x.asset_entity_id,
                        principalSchema: "public",
                        principalTable: "assets",
                        principalColumn: "id");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "fk_tasks_checklists_checklist_id",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_assets_and_maintenances_maintenance_id",
                schema: "public",
                table: "assets_and_maintenances",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_parts_asset_entity_id",
                schema: "public",
                table: "parts",
                column: "asset_entity_id");
