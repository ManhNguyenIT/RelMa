  ...
  return (
    <MainCard title="Customized" codeString={customTreeviewCodeString}>
      <SimpleTreeView
        ...
        sx={{ height: 320, flexGrow: 1, overflowY: 'auto' }}
      >
        <StyledTreeItem itemId="1" label="Main" slots={{ groupTransition: TransitionComponent }}>
          <StyledTreeItem itemId="2" label="Hello" />
          <StyledTreeItem itemId="3" label="Subtree with children" slots={{ groupTransition: TransitionComponent }}>
            <StyledTreeItem itemId="6" label="Hello" />
            <StyledTreeItem itemId="7" label="Sub-subtree with children" slots={{ groupTransition: TransitionComponent }}>
              <StyledTreeItem itemId="9" label="Child 1" />
              <StyledTreeItem itemId="10" label="Child 2" />
              <StyledTreeItem itemId="11" label="Child 3" />
            </StyledTreeItem>
