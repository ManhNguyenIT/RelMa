...
export default function DraggableRow({
  ...
  return (
    <TableRow
      ref={previewRef as unknown as React.Ref<any>} //previewRef could go here
      sx={{ opacity: isDragging ? 0.5 : 1, bgcolor: isOverCurrent ? 'primary.lighter' : 'inherit' }}
    >
      <TableCell ref={dropRef as unknown as React.Ref<any>}>
        <IconButton
          ref={dragRef as unknown as React.Ref<any>}
          size="small"
