...
using RelMa.Application.UseCases.Tasks.V1.Commands;
using RelMa.Application.UseCases.Tasks.V1.Queries;
...
internal sealed class TaskEndpoint : IEndpoint
{
    private const string BaseUrl = "/api/v{version:apiVersion}/tasks";
