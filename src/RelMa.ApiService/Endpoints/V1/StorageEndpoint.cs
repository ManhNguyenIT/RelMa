...
using RelMa.Application.UseCases.Storages.V1.Commands;
using RelMa.Application.UseCases.Storages.V1.Queries;
...
internal sealed class StorageEndpoint : IEndpoint
{
    private const string BaseUrl = "/api/v{version:apiVersion}/storages";
    ...
    public static async Task<PagedResult<StorageResponse>?> List(
        IMediator mediator,
        IDistributedCache cache,
        IUserContext userContext,
        [AsParameters] GetStorageQuery query,
    ...
    public static async Task<bool> Delete(
        ...
        IConnectionMultiplexer multiplexer,
        IOptions<RedisCacheOptions> options,
        [AsParameters] DeleteStorageCommand command,
        CancellationToken cancellationToken)
    {
